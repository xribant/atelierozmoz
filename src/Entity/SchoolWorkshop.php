...
#[ORM\Entity(repositoryClass: SchoolWorkshopRepository::class)]
#[Vich\Uploadable]
class SchoolWorkshop
{
    ...
    #[Vich\UploadableField(mapping: 'school_workshop_image', fileNameProperty: 'imageName')]
    #[Assert\File(
        maxSize: '1M',
     ...
     */
    public function setImageFile(?File $imageFile): SchoolWorkshop
    {
